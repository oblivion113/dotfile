...
# Open a file/URL with the Windows default app (WSL interop).
...
# Windows host details (the $WIN shortcut to the Windows user profile)
...
# Real projects get their own environment (see the python-workflow skill).
